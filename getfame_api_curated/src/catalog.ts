...
const CuratedServiceSchema = z.object({
  id: z.number(), // JAP service id
  social: z.string(), // 'instagram' | 'tiktok' | etc
  name: z.string(),
  category: z.string(),
  ...
  price: z.number().optional(), // overrides computed price
  markup: z.number().optional(), // multiplier over JAP rate
  min: z.number().optional(),
  max: z.number().optional(),
  fields: z.array(z.string()).optional(), // e.g., ['link','quantity']
});
